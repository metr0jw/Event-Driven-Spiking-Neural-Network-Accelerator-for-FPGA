...
module snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_113 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ap_idle,
        ap_ready,
        weight_sum_24_reload,
        weight_sum_26_out,
        weight_sum_26_out_ap_vld,
...
output   ap_idle;
output   ap_ready;
input  [15:0] weight_sum_24_reload;
output  [15:0] weight_sum_26_out;
output   weight_sum_26_out_ap_vld;
...
reg   [0:0] icmp_ln529_reg_356;
wire   [2:0] trunc_ln529_fu_236_p1;
reg   [2:0] trunc_ln529_reg_360;
wire   [7:0] tmp_5_fu_281_p19;
reg   [7:0] tmp_5_reg_405;
wire   [63:0] zext_ln530_5_fu_264_p1;
wire    ap_block_pp0_stage0;
reg   [15:0] weight_sum_fu_86;
wire   [15:0] weight_sum_9_fu_326_p2;
wire    ap_loop_init;
...
wire   [2:0] zext_ln530_fu_248_p1;
wire   [5:0] tmp_s_fu_252_p3;
wire  signed [6:0] sext_ln530_fu_260_p1;
wire   [7:0] tmp_5_fu_281_p17;
wire  signed [15:0] sext_ln530_6_fu_323_p1;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_5_fu_281_p1;
wire   [2:0] tmp_5_fu_281_p3;
wire   [2:0] tmp_5_fu_281_p5;
wire   [2:0] tmp_5_fu_281_p7;
wire  signed [2:0] tmp_5_fu_281_p9;
wire  signed [2:0] tmp_5_fu_281_p11;
wire  signed [2:0] tmp_5_fu_281_p13;
wire  signed [2:0] tmp_5_fu_281_p15;
wire    ap_ce_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln529_reg_356 == 1'd1))) begin
        weight_sum_26_out_ap_vld = 1'b1;
    end else begin
        weight_sum_26_out_ap_vld = 1'b0;
    end
end
...
assign add_ln529_fu_230_p2 = (ap_sig_allocacmp_j_9 + 5'd1);
...
assign icmp_ln529_fu_224_p2 = ((ap_sig_allocacmp_j_9 == 5'd16) ? 1'b1 : 1'b0);

assign p_ZL13weight_memory_0_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_0_ce0 = p_ZL13weight_memory_0_ce0_local;

assign p_ZL13weight_memory_1_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_1_ce0 = p_ZL13weight_memory_1_ce0_local;

assign p_ZL13weight_memory_2_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_2_ce0 = p_ZL13weight_memory_2_ce0_local;

assign p_ZL13weight_memory_3_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_3_ce0 = p_ZL13weight_memory_3_ce0_local;

assign p_ZL13weight_memory_4_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_4_ce0 = p_ZL13weight_memory_4_ce0_local;

assign p_ZL13weight_memory_5_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_5_ce0 = p_ZL13weight_memory_5_ce0_local;

assign p_ZL13weight_memory_6_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_6_ce0 = p_ZL13weight_memory_6_ce0_local;

assign p_ZL13weight_memory_7_address0 = zext_ln530_5_fu_264_p1;

assign p_ZL13weight_memory_7_ce0 = p_ZL13weight_memory_7_ce0_local;

assign sext_ln530_6_fu_323_p1 = $signed(tmp_5_reg_405);

assign sext_ln530_fu_260_p1 = $signed(tmp_s_fu_252_p3);

assign tmp_5_fu_281_p17 = 'bx;

assign tmp_fu_240_p3 = ap_sig_allocacmp_j_9[32'd3];

assign tmp_s_fu_252_p3 = {{3'd5}, {zext_ln530_fu_248_p1}};

assign trunc_ln529_fu_236_p1 = ap_sig_allocacmp_j_9[2:0];

assign weight_sum_26_out = weight_sum_fu_86;

assign weight_sum_9_fu_326_p2 = ($signed(sext_ln530_6_fu_323_p1) + $signed(weight_sum_fu_86));

assign zext_ln530_5_fu_264_p1 = $unsigned(sext_ln530_fu_260_p1);

assign zext_ln530_fu_248_p1 = tmp_fu_240_p3;

endmodule //snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_113
