...
entity snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_113 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_113 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln529_reg_356 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln529_fu_236_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal trunc_ln529_reg_360 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p19 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_5_reg_405 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln530_5_fu_264_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal weight_sum_fu_86 : STD_LOGIC_VECTOR (15 downto 0) := "0000000000000000";
    signal weight_sum_9_fu_326_p2 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal zext_ln530_fu_248_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_s_fu_252_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal sext_ln530_fu_260_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_5_fu_281_p17 : STD_LOGIC_VECTOR (7 downto 0);
    signal sext_ln530_6_fu_323_p1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal tmp_5_fu_281_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p5 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p7 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p9 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p11 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p13 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_5_fu_281_p15 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    sparsemux_17_3_8_1_1_U404 : component snn_top_hls_sparsemux_17_3_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "000",
    ...
    port map (
        ...
        def => tmp_5_fu_281_p17,
        sel => trunc_ln529_reg_360,
        dout => tmp_5_fu_281_p19);
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    weight_sum_fu_86 <= weight_sum_24_reload;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    weight_sum_fu_86 <= weight_sum_9_fu_326_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln529_reg_356 <= icmp_ln529_fu_224_p2;
                tmp_5_reg_405 <= tmp_5_fu_281_p19;
                trunc_ln529_reg_360 <= trunc_ln529_fu_236_p1;
            end if;
        end if;
    end process;
    ...
    add_ln529_fu_230_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_9) + unsigned(ap_const_lv5_1));
    ...
    ap_sig_allocacmp_j_9_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_90)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j_9 <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_j_9 <= j_fu_90;
        end if; 
    end process;

    icmp_ln529_fu_224_p2 <= "1" when (ap_sig_allocacmp_j_9 = ap_const_lv5_10) else "0";
    p_ZL13weight_memory_0_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_1_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_2_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_3_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_4_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_5_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_6_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_7_address0 <= zext_ln530_5_fu_264_p1(9 - 1 downto 0);
    ...
    begin
        ...
        sext_ln530_6_fu_323_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_5_reg_405),16));

        sext_ln530_fu_260_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_s_fu_252_p3),7));

    tmp_5_fu_281_p17 <= "XXXXXXXX";
    tmp_fu_240_p3 <= ap_sig_allocacmp_j_9(3 downto 3);
    tmp_s_fu_252_p3 <= (ap_const_lv3_5 & zext_ln530_fu_248_p1);
    trunc_ln529_fu_236_p1 <= ap_sig_allocacmp_j_9(3 - 1 downto 0);
    weight_sum_26_out <= weight_sum_fu_86;

    weight_sum_26_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln529_reg_356, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (icmp_ln529_reg_356 = ap_const_lv1_1))) then 
            weight_sum_26_out_ap_vld <= ap_const_logic_1;
        else 
            weight_sum_26_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    weight_sum_9_fu_326_p2 <= std_logic_vector(signed(sext_ln530_6_fu_323_p1) + signed(weight_sum_fu_86));
    zext_ln530_5_fu_264_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln530_fu_260_p1),64));
    zext_ln530_fu_248_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_240_p3),3));
end behav;
