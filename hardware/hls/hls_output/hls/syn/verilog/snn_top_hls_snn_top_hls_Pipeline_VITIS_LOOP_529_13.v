...
module snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_13 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [13:0] weight_sum_4_reload;
output  [13:0] weight_sum_6_out;
output   weight_sum_6_out_ap_vld;
...
wire   [7:0] tmp_9_fu_283_p19;
reg   [7:0] tmp_9_reg_407;
wire   [63:0] zext_ln530_fu_266_p1;
wire    ap_block_pp0_stage0;
reg   [13:0] weight_sum_6_fu_88;
...
wire   [2:0] zext_ln530_1_fu_250_p1;
wire   [3:0] tmp_s_fu_254_p3;
wire  signed [4:0] sext_ln530_fu_262_p1;
wire   [7:0] tmp_9_fu_283_p17;
wire  signed [13:0] sext_ln530_3_fu_325_p1;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_9_fu_283_p1;
wire   [2:0] tmp_9_fu_283_p3;
wire   [2:0] tmp_9_fu_283_p5;
wire   [2:0] tmp_9_fu_283_p7;
wire  signed [2:0] tmp_9_fu_283_p9;
wire  signed [2:0] tmp_9_fu_283_p11;
wire  signed [2:0] tmp_9_fu_283_p13;
wire  signed [2:0] tmp_9_fu_283_p15;
wire    ap_ce_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln529_reg_358 == 1'd1))) begin
        weight_sum_6_out_ap_vld = 1'b1;
    end else begin
        weight_sum_6_out_ap_vld = 1'b0;
    end
end
...
assign add_ln529_fu_232_p2 = (ap_sig_allocacmp_j + 5'd1);
...
assign icmp_ln529_fu_226_p2 = ((ap_sig_allocacmp_j == 5'd16) ? 1'b1 : 1'b0);
...
assign sext_ln530_3_fu_325_p1 = $signed(tmp_9_reg_407);

assign sext_ln530_fu_262_p1 = $signed(tmp_s_fu_254_p3);

assign tmp_9_fu_283_p17 = 'bx;

assign tmp_fu_242_p3 = ap_sig_allocacmp_j[32'd3];

assign tmp_s_fu_254_p3 = {{1'd1}, {zext_ln530_1_fu_250_p1}};

assign trunc_ln529_fu_238_p1 = ap_sig_allocacmp_j[2:0];

assign weight_sum_6_out = weight_sum_6_fu_88;

assign weight_sum_fu_328_p2 = ($signed(sext_ln530_3_fu_325_p1) + $signed(weight_sum_6_fu_88));

assign zext_ln530_1_fu_250_p1 = tmp_fu_242_p3;

assign zext_ln530_fu_266_p1 = $unsigned(sext_ln530_fu_262_p1);

endmodule //snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_13
