...
entity snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_110 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_110 is 
...
attribute shreg_extract : string;
    ...
    signal weight_sum_12_fu_322_p2 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal zext_ln526_fu_248_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_41_cast_fu_252_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_s_fu_277_p17 : STD_LOGIC_VECTOR (7 downto 0);
    signal sext_ln530_fu_319_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    sparsemux_17_3_8_1_1_U371 : component snn_top_hls_sparsemux_17_3_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "000",
    ...
    add_ln529_fu_230_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_12) + unsigned(ap_const_lv5_1));
    ...
    icmp_ln529_fu_224_p2 <= "1" when (ap_sig_allocacmp_j_12 = ap_const_lv5_10) else "0";
    ...
    begin
        ...
        sext_ln530_fu_319_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_s_reg_401),16));

    tmp_41_cast_fu_252_p3 <= (ap_const_lv3_5 & zext_ln526_fu_248_p1);
    tmp_fu_240_p3 <= ap_sig_allocacmp_j_12(3 downto 3);
    tmp_s_fu_277_p17 <= "XXXXXXXX";
    trunc_ln529_fu_236_p1 <= ap_sig_allocacmp_j_12(3 - 1 downto 0);
    weight_sum_12_fu_322_p2 <= std_logic_vector(signed(sext_ln530_fu_319_p1) + signed(weight_sum_fu_86));
    weight_sum_20_out <= weight_sum_fu_86;

    weight_sum_20_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln529_reg_352, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (icmp_ln529_reg_352 = ap_const_lv1_1))) then 
            weight_sum_20_out_ap_vld <= ap_const_logic_1;
        else 
            weight_sum_20_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln526_fu_248_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_240_p3),4));
    zext_ln530_fu_260_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_41_cast_fu_252_p3),64));
end behav;
