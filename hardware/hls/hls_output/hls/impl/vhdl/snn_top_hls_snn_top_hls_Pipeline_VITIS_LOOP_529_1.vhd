...
entity snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln529_fu_214_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln529_reg_330 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln529_fu_226_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal trunc_ln529_reg_334 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p19 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_reg_379 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln526_fu_238_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal weight_sum_fu_82 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal weight_sum_13_fu_300_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_exit_ready_pp0_iter1_reg : STD_LOGIC;
    signal j_2_fu_86 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
    signal add_ln529_fu_220_p2 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_2_fu_255_p17 : STD_LOGIC_VECTOR (7 downto 0);
    signal sext_ln530_fu_297_p1 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_2_fu_255_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p5 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p7 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p9 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p11 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p13 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2_fu_255_p15 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    sparsemux_17_3_8_1_1_U262 : component snn_top_hls_sparsemux_17_3_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "000",
    ...
    port map (
        ...
        def => tmp_2_fu_255_p17,
        sel => trunc_ln529_reg_334,
        dout => tmp_2_fu_255_p19);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln529_fu_214_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    j_2_fu_86 <= add_ln529_fu_220_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_2_fu_86 <= ap_const_lv5_0;
                end if;
            end if; 
        end if;
    end process;

    weight_sum_fu_82_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    weight_sum_fu_82 <= ap_const_lv12_0;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    weight_sum_fu_82 <= weight_sum_13_fu_300_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln529_reg_330 <= icmp_ln529_fu_214_p2;
                tmp_2_reg_379 <= tmp_2_fu_255_p19;
                trunc_ln529_reg_334 <= trunc_ln529_fu_226_p1;
            end if;
        end if;
    end process;
    ...
    add_ln529_fu_220_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv5_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln529_fu_214_p2)
    begin
        if (((icmp_ln529_fu_214_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_j_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_2_fu_86)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_j <= j_2_fu_86;
        end if; 
    end process;

    icmp_ln529_fu_214_p2 <= "1" when (ap_sig_allocacmp_j = ap_const_lv5_10) else "0";
    p_ZL13weight_memory_0_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_1_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_2_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_3_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_4_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_5_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_6_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    p_ZL13weight_memory_7_address0 <= zext_ln526_fu_238_p1(9 - 1 downto 0);
    ...
    begin
        ...
        sext_ln530_fu_297_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_2_reg_379),12));

    tmp_2_fu_255_p17 <= "XXXXXXXX";
    tmp_fu_230_p3 <= ap_sig_allocacmp_j(3 downto 3);
    trunc_ln529_fu_226_p1 <= ap_sig_allocacmp_j(3 - 1 downto 0);
    weight_sum_13_fu_300_p2 <= std_logic_vector(signed(sext_ln530_fu_297_p1) + signed(weight_sum_fu_82));
    weight_sum_out <= weight_sum_fu_82;

    weight_sum_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln529_reg_330, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (icmp_ln529_reg_330 = ap_const_lv1_1))) then 
    ...
    zext_ln526_fu_238_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_230_p3),64));
end behav;
