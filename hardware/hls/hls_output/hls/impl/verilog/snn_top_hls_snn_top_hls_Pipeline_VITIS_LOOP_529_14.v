...
module snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_14 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [13:0] sext_ln529_2;
output  [14:0] weight_sum_8_out;
output   weight_sum_8_out_ap_vld;
...
wire   [14:0] weight_sum_6_fu_328_p2;
wire  signed [14:0] sext_ln529_2_cast_fu_213_p1;
wire    ap_loop_init;
...
wire   [4:0] zext_ln530_2_fu_254_p1;
wire   [5:0] tmp_32_cast_fu_258_p3;
wire   [7:0] tmp_s_fu_283_p17;
wire  signed [14:0] sext_ln530_fu_325_p1;
reg    ap_done_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln529_reg_358 == 1'd1))) begin
        weight_sum_8_out_ap_vld = 1'b1;
    end else begin
        weight_sum_8_out_ap_vld = 1'b0;
    end
end
...
assign add_ln529_fu_236_p2 = (ap_sig_allocacmp_j_6 + 5'd1);
...
assign icmp_ln529_fu_230_p2 = ((ap_sig_allocacmp_j_6 == 5'd16) ? 1'b1 : 1'b0);
...
assign sext_ln529_2_cast_fu_213_p1 = $signed(sext_ln529_2);

assign sext_ln530_fu_325_p1 = $signed(tmp_s_reg_407);

assign tmp_32_cast_fu_258_p3 = {{1'd1}, {zext_ln530_2_fu_254_p1}};

assign tmp_fu_246_p3 = ap_sig_allocacmp_j_6[32'd3];

assign tmp_s_fu_283_p17 = 'bx;

assign trunc_ln529_fu_242_p1 = ap_sig_allocacmp_j_6[2:0];

assign weight_sum_6_fu_328_p2 = ($signed(sext_ln530_fu_325_p1) + $signed(weight_sum_fu_88));

assign weight_sum_8_out = weight_sum_fu_88;

assign zext_ln530_2_fu_254_p1 = tmp_fu_246_p3;

assign zext_ln530_fu_266_p1 = tmp_32_cast_fu_258_p3;

endmodule //snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_14
