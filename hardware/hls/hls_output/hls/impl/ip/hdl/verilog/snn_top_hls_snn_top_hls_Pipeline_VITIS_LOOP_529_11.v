...
module snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [11:0] sext_ln529;
output  [12:0] weight_sum_2_out;
output   weight_sum_2_out_ap_vld;
...
wire   [7:0] tmp_6_fu_283_p19;
reg   [7:0] tmp_6_reg_407;
wire   [63:0] zext_ln530_8_fu_266_p1;
wire    ap_block_pp0_stage0;
reg   [12:0] weight_sum_2_fu_88;
wire   [12:0] weight_sum_fu_328_p2;
wire  signed [12:0] sext_ln529_cast_fu_213_p1;
wire    ap_loop_init;
...
wire   [2:0] zext_ln530_fu_254_p1;
wire   [3:0] tmp_28_cast_fu_258_p3;
wire   [7:0] tmp_6_fu_283_p17;
wire  signed [12:0] sext_ln530_1_fu_325_p1;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] tmp_6_fu_283_p1;
wire   [2:0] tmp_6_fu_283_p3;
wire   [2:0] tmp_6_fu_283_p5;
wire   [2:0] tmp_6_fu_283_p7;
wire  signed [2:0] tmp_6_fu_283_p9;
wire  signed [2:0] tmp_6_fu_283_p11;
wire  signed [2:0] tmp_6_fu_283_p13;
wire  signed [2:0] tmp_6_fu_283_p15;
wire    ap_ce_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln529_reg_358 == 1'd1))) begin
        weight_sum_2_out_ap_vld = 1'b1;
    end else begin
        weight_sum_2_out_ap_vld = 1'b0;
    end
end
...
assign add_ln529_fu_236_p2 = (ap_sig_allocacmp_j + 5'd1);
...
assign icmp_ln529_fu_230_p2 = ((ap_sig_allocacmp_j == 5'd16) ? 1'b1 : 1'b0);

assign p_ZL13weight_memory_0_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_0_ce0 = p_ZL13weight_memory_0_ce0_local;

assign p_ZL13weight_memory_1_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_1_ce0 = p_ZL13weight_memory_1_ce0_local;

assign p_ZL13weight_memory_2_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_2_ce0 = p_ZL13weight_memory_2_ce0_local;

assign p_ZL13weight_memory_3_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_3_ce0 = p_ZL13weight_memory_3_ce0_local;

assign p_ZL13weight_memory_4_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_4_ce0 = p_ZL13weight_memory_4_ce0_local;

assign p_ZL13weight_memory_5_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_5_ce0 = p_ZL13weight_memory_5_ce0_local;

assign p_ZL13weight_memory_6_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_6_ce0 = p_ZL13weight_memory_6_ce0_local;

assign p_ZL13weight_memory_7_address0 = zext_ln530_8_fu_266_p1;

assign p_ZL13weight_memory_7_ce0 = p_ZL13weight_memory_7_ce0_local;

assign sext_ln529_cast_fu_213_p1 = $signed(sext_ln529);

assign sext_ln530_1_fu_325_p1 = $signed(tmp_6_reg_407);

assign tmp_28_cast_fu_258_p3 = {{1'd1}, {zext_ln530_fu_254_p1}};

assign tmp_6_fu_283_p17 = 'bx;

assign tmp_fu_246_p3 = ap_sig_allocacmp_j[32'd3];

assign trunc_ln529_fu_242_p1 = ap_sig_allocacmp_j[2:0];

assign weight_sum_2_out = weight_sum_2_fu_88;

assign weight_sum_fu_328_p2 = ($signed(sext_ln530_1_fu_325_p1) + $signed(weight_sum_2_fu_88));

assign zext_ln530_8_fu_266_p1 = tmp_28_cast_fu_258_p3;

assign zext_ln530_fu_254_p1 = tmp_fu_246_p3;

endmodule //snn_top_hls_snn_top_hls_Pipeline_VITIS_LOOP_529_11
