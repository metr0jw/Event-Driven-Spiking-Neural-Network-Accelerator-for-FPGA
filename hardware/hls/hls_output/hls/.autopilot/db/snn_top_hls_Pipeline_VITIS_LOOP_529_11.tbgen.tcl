set moduleName snn_top_hls_Pipeline_VITIS_LOOP_529_11
set isTopModule 0
...
set cdfgNum 31
set C_modelName {snn_top_hls_Pipeline_VITIS_LOOP_529_11}
...
set C_modelArgList {
	{ sext_ln529 int 12 regular  }
	{ weight_sum_2_out int 13 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln529", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "weight_sum_2_out", "interface" : "wire", "bitwidth" : 13, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sext_ln529 sc_in sc_lv 12 signal 0 } 
	{ weight_sum_2_out sc_out sc_lv 13 signal 1 } 
	{ weight_sum_2_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln529", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sext_ln529", "role": "default" }} , 
 	{ "name": "weight_sum_2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "weight_sum_2_out", "role": "default" }} , 
 	{ "name": "weight_sum_2_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "weight_sum_2_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	sext_ln529 { ap_none {  { sext_ln529 in_data 0 12 } } }
	weight_sum_2_out { ap_vld {  { weight_sum_2_out out_data 1 13 }  { weight_sum_2_out_ap_vld out_vld 1 1 } } }
