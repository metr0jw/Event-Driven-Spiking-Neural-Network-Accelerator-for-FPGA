set moduleName snn_top_hls_Pipeline_VITIS_LOOP_529_13
set isTopModule 0
...
set cdfgNum 31
set C_modelName {snn_top_hls_Pipeline_VITIS_LOOP_529_13}
...
set C_modelArgList {
	{ weight_sum_4_reload int 14 regular  }
	{ weight_sum_6_out int 14 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "weight_sum_4_reload", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "weight_sum_6_out", "interface" : "wire", "bitwidth" : 14, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ weight_sum_4_reload sc_in sc_lv 14 signal 0 } 
	{ weight_sum_6_out sc_out sc_lv 14 signal 1 } 
	{ weight_sum_6_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_sum_4_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "weight_sum_4_reload", "role": "default" }} , 
 	{ "name": "weight_sum_6_out", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "weight_sum_6_out", "role": "default" }} , 
 	{ "name": "weight_sum_6_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "weight_sum_6_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	weight_sum_4_reload { ap_none {  { weight_sum_4_reload in_data 0 14 } } }
	weight_sum_6_out { ap_vld {  { weight_sum_6_out out_data 1 14 }  { weight_sum_6_out_ap_vld out_vld 1 1 } } }
