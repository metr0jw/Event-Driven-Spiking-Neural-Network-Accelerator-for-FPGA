#-----------------------------------------------------------------------------
# Title         : SNN Top-Level HLS Synthesis Script (Batch Mode)
# Project       : PYNQ-Z2 SNN Accelerator
# File          : run_snn_top_hls_batch.tcl
# Description   : Vitis HLS synthesis script with absolute paths for batch execution
#-----------------------------------------------------------------------------

# Absolute paths for batch execution
set hls_root "/home/jwlee/workspace/Event-Driven-Spiking-Neural-Network-Accelerator-for-FPGA/hardware/hls"
set proj_root "/home/jwlee/workspace/Event-Driven-Spiking-Neural-Network-Accelerator-for-FPGA"
...
# Change to HLS directory for project creation
cd $hls_root

puts "=============================================="
puts "SNN Top-Level HLS Synthesis"
puts "=============================================="
puts "HLS Root: $hls_root"
