//-----------------------------------------------------------------------------
// Title         : SNN Learning Engine Optimized Header
// Project       : PYNQ-Z2 SNN Accelerator
// File          : snn_learning_engine_optimized.h
// Author        : Jiwoon Lee (@metr0jw)
// Organization  : Kwangwoon University, Seoul, South Korea
// Description   : Optimized STDP learning with multiple strategies
//-----------------------------------------------------------------------------

#ifndef SNN_LEARNING_ENGINE_OPTIMIZED_H
#define SNN_LEARNING_ENGINE_OPTIMIZED_H

#include "snn_types.h"

// Learning configuration structure (same as original)
...
// Optimized learning engine function
...
#endif // SNN_LEARNING_ENGINE_OPTIMIZED_H
